...
ads = serialize.AnalysisDeserializer("./analysis/test/serum-rp-unregularized-glyspace.db")
ads2 = serialize.AnalysisDeserializer("./analysis/test/serum-rp-prior-glyspace.db")
ads3 = serialize.AnalysisDeserializer("./analysis/test/serum-rp-grid-glyspace.db")
...
plt.savefig("figure/glyspace_serum_roc.pdf", bbox_inches='tight')
...
ax.axes.spines['right'].set_visible(False)
ax.axes.spines['top'].set_visible(False)
plt.savefig("figure/glyspace_serum_prec_rec.pdf", bbox_inches='tight')
...
fig.savefig("figure/glyspace_rp_serum_chromatograms.pdf", bbox_inches='tight')
